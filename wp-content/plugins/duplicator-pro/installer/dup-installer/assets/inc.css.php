...
<style>
	...
	div.progress-text {font-size:1.7em; margin-bottom:20px}
    div#secondary-progress-text { font-size:.85em; margin-bottom:20px }
	div#progress-notice:not(:empty) { color:maroon; font-size:.85em; margin-bottom:20px; }
