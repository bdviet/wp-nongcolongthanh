...
<form id='s3-input-form' method="post" class="content-form">
                    ...
                    <td>
                        ...
                        ?>
                            <div style="margin-top: 10px;">
                                <input style="width: 42%!important;" type="text" name="mu_search[<?php echo intval($subsite->id); ?>]" id="url_old_<?php echo intval($subsite->id); ?>" value="<?php echo $subsite->name ?>" readonly="readonly"  class="readonly" />
                                to
								<?php
								$url_new = DUPX_U::getDefaultURL($subsite->name,$main_url,$is_subdomain);
								?>
                                <input style="width: 42%!important;" type="text" 
									name="mu_replace[<?php echo intval($subsite->id); ?>]" id="url_new_<?php echo intval($subsite->id); ?>" 
    ...
    <div id="s3-custom-replace" style="display:none;">
        <div class="help-target">
            <a href="<?php echo $GLOBALS['_HELP_URL_PATH'];?>#help-s3" target="help"><i class="fas fa-question-circle fa-sm"></i></a>
        </div><br/>
...
<form id='s3-result-form' method="post" class="content-form" style="display:none">
	...
	<div id="progress-area">
		<div style="width:500px; margin:auto">
			<div class="progress-text"><i class="fas fa-circle-notch fa-spin"></i> Processing Data Replacement</div>
